...
//    MEDICINE CRUD OPERATION:
    public void addMedicine(SQLiteDatabase db, @NonNull int user_id, @NonNull String med_name, @NonNull String quantity, @NonNull String date_time, @NonNull String days){
        ContentValues values = new ContentValues();
        values.put("USER_ID",user_id);
        values.put("MED_NAME",med_name);
        values.put("DESCRIPTION",quantity);
        values.put("DATE_TIME",date_time);
        values.put("DAYS",days);
        values.put("ENABLE",false);
        db.insert("MEDICINE",null,values);
    }
    public void addHistory(SQLiteDatabase db, @NonNull int user_id, @NonNull String med_name, @NonNull String quantity, @NonNull String date_time){
        ContentValues values = new ContentValues();
        values.put("USER_ID",user_id);
        values.put("MED_NAME",med_name);
        values.put("DESCRIPTION",quantity);
